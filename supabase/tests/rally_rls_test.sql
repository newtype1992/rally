...
SELECT is(
  ...
  'already_complete',
  'duplicate same-day completion converges successfully'
);
...
SELECT is(
  ...
  'already_absent',
  'undo missing completion converges successfully'
);
...
SELECT is(
  public.archive_habit(jsonb_build_object('habit_id', '01000000-0000-4000-8000-000000000001')) #>> '{data,outcome}',
  'already_archived',
  'archive_habit is idempotent'
);
...
SELECT is(
  public.delete_habit(jsonb_build_object('habit_id', '01000000-0000-4000-8000-000000000001')) #>> '{data,outcome}',
  'already_deleted',
  'delete_habit is idempotent'
);
